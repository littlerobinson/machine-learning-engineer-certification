...
requests_cache.install_cache('weather_map_api_cache', expire_after=int(os.environ['OPENWEATHERMAP_CACHE_EXPIRATION']))
...
class WeatherMapApi:
    ...
    def __init__(self, df: pd.DataFrame):
        ...
        try:
            ...
            if 'lat' not in df.columns or 'lon' not in df.columns:
                raise KeyError("Columns 'lat' and 'lon' are not present in the DataFrame.")
    ...
    def create_output_result(self, df: pd.DataFrame, file_path: str = 'data/weather_infos.csv'):
